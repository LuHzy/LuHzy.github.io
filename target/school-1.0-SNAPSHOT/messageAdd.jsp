...
<div class="main-content">
    ...
    <div id="page-wrapper">
        <div class="main-page">
            <div class="forms">
                <h2 class="title1">添加消息：</h2>
                <div class="row">
                    <div class="form-three widget-shadow">
                        <div class=" panel-body-inputin">
                            <form class="form-horizontal"  method="post" id="msgForm">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input id="title" class="form-control1" type="text" placeholder="标题" name="title">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" rows="10" id="context" name="context"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <button class="btn btn-success" type="button" id="sub">保存</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<script>
    $(function () {
        $("#sub").click(function () {
            let message = $("#msgForm").serializeArray();
            //console.log(message);
            ...
            $.ajax({
                ...
                success:function (res) {
                    if(res){
                        ...
                        alert("保存出错，请检查一下您的数据内容或重试，联系管理员!");
                    }
                },
                error:function (err) {
                    alert("保存出错，请检查一下您的数据内容或重试，联系管理员!")
