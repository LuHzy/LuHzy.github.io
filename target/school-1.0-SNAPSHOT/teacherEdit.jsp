...
<div class="main-content">
    ...
    <div id="page-wrapper">
        <div class="main-page">
            <div class="forms">
                <h2 class="title1">编辑老师信息：</h2>
                <div class="row">
                    <div class="form-three widget-shadow">
                        <div class=" panel-body-inputin">
                            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/teacher/update">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input id="t_id" readonly="readonly" name="id" class="form-control1" type="text" placeholder="编号" value="${teacher.id}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input id="teacherName" name="name" class="form-control1" type="text" placeholder="老师姓名" value="${teacher.name}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <c:if test="${ teacher.img != null}">
                                            <img style="width: 60px;height: 70px" src="${pageContext.request.contextPath}/${teacher.img}" alt="">
                                        </c:if>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="radio-inline"><label><input type="radio" name="gender" value="1" <c:if test="${teacher.gender==1}">checked</c:if>> 男</label></div>
                                        <div class="radio-inline"><label><input type="radio" name="gender" value="0" <c:if test="${teacher.gender==0}">checked</c:if>> 女</label></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input id="email" class="form-control1" type="text" placeholder="地址" name="address" value="${teacher.address}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input type="text" class="form-control1" placeholder="手机号" name="phone" value="${teacher.phone}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">教龄</label>
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
													<span class="input-group-addon">
														<i class="fa fa-calendar"></i>
													</span>
                                            <input type="text" class="form-control1" placeholder="教龄" name="jl" value="${teacher.jl}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
