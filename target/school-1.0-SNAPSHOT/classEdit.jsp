...
<div class="main-content">
    ...
    <div id="page-wrapper">
        <div class="main-page">
            <div class="forms">
                <h2 class="title1">编辑班级信息：</h2>
                <div class="row">
                    <div class="form-three widget-shadow">
                        <div class=" panel-body-inputin">
                            <form class="form-horizontal" action="${pageContext.request.contextPath}/class/update" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input id="className" name="name" class="form-control" style="width: 300px;" type="text" placeholder="班级" value="${classes.name}">
                                            <input type="hidden" value="${classes.id}" name="id">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">开班时间</label>
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
													<span class="input-group-addon">
														<i class="fa fa-clock-o"></i>
													</span>
                                            <input id="openDate" name="openDate" class="form-control" style="width: 300px;" type="date" placeholder="开班时间"
                                                   value="<fmt:formatDate value="${classes.openDate}" type="Date"
                                ...
                                <div class="form-group">
                                    <label for="radio" class="col-sm-2 control-label">结班</label>
                                    <div class="col-sm-8">
                                        <div class="radio-inline"><label><input type="radio" name="open" value="1"
                                                                                <c:if test="${classes.endDate!=null}">checked</c:if>
                                        > 是</label></div>

                                        <div class="radio-inline"><label><input type="radio" name="open" value="0"
                                                                                <c:if test="${classes.endDate==null}">checked</c:if>
                                        > 否</label></div>
                                    </div>
                                </div>
