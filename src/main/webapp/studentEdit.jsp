...
<div class="main-content">
    ...
    <div id="page-wrapper">
        <div class="main-page">
            <div class="forms">
                <h2 class="title1">编辑学员信息：</h2>
                <div class="row">
                    <div class="form-three widget-shadow">
                        <div class=" panel-body-inputin">
                            <form class="form-horizontal" action="${pageContext.request.contextPath}/student/update" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-md-2 control-label">学员编号</label>
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
													<span class="input-group-addon">
														<i class="fa fa-envelope-o"></i>
													</span>
                                            <input id="id" name="id" value="${student.id}" readonly class="form-control1" type="text" placeholder="学员编号">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input id="name" name="name" value="${student.name}" class="form-control1" type="text" placeholder="学员姓名">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">=
                                        <div class="input-group input-icon right">
                                            ...
                                            <input type="Date" name="birthday" value="<fmt:formatDate value="${student.birthday}" pattern="yyyy-MM-dd"></fmt:formatDate>" class="form-control1" placeholder="出生日期">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <p class="help-block">请选择一个以jpg结尾的图像</p>
                                        <c:if test="${ student.img != null}">
                                            <img style="width: 60px;height: 70px" src="${pageContext.request.contextPath}/${student.img}" alt="">
                                        </c:if>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="radio-inline"><label><input type="radio" name="gender" value="1"  <c:if test="${student.gender eq 1}">checked</c:if> > 男</label></div>
                                        <div class="radio-inline"><label><input type="radio" name="gender" value="0"  <c:if test="${student.gender eq 0}">checked</c:if>> 女</label></div>
                                    </div>
                                </div>
                                <div class="form-group has-success">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input id="email" class="form-control1" type="text" placeholder="地址" name="address" value="${student.address}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group has-error">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input type="text" class="form-control1" placeholder="手机号" name="phone" value="${student.phone}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">班级列表</label>
                                    <div class="col-sm-8">
                                        <select  class="form-control1" name="classId">
                                            <c:forEach items="${classList}" var="classes">
                                                <option value="${classes.id}"
                                                        <c:if test="${student.classId eq classes.id}">selected</c:if>
                                                >${classes.name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
