...
<div class="main-content">
    ...
    <div id="page-wrapper">
        <div class="main-page">
            <div class="forms">
                <h2 class="title1">添加老师信息：</h2>
                <div class="row">
                    <div class="form-three widget-shadow">
                        <div class=" panel-body-inputin">
                            <form action="${pageContext.request.contextPath}/teacher/save" method="post" class="form-horizontal">
                                <input type="hidden" name="dirName" value="teacher">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input id="name" name="name" class="form-control1" type="text"
                                                   placeholder="老师姓名">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="radio-inline"><label><input type="radio" name="gender" value="1"> 男</label>
                                        </div>
                                        <div class="radio-inline"><label><input type="radio" name="gender" value="0"
                                                                                checked> 女</label></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input id="address" name="address" class="form-control1" type="text"
                                                   placeholder="地址">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input type="text" name="phone" class="form-control1" placeholder="手机号">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input type="number" name="jl" id="jl">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
