                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="${pageContext.request.contextPath}/classList.jsp"> 班级列表</a></li>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input id="studentName" class="form-control1" type="text" placeholder="学员姓名" name="name">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input type="date" class="form-control1" placeholder="出生日期" name="birthday">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="radio-inline"><label><input type="radio" name="gender" value="1"> 男</label></div>
                                        <div class="radio-inline"><label><input type="radio" name="gender" value="0"> 女</label></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input id="email" class="form-control1" type="text" placeholder="地址" name="address">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input type="text" class="form-control1" placeholder="手机号" name="phone">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
